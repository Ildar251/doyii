		...
		translations: {
			ru: {
				...
				'email.Settings.email.plugin.subTitle':
					'Протестируйте настройки плагина электронной почты.',
				...
				'cloud.Homepage.githubBox.title.not-versioned':
				...
				'cloud.Homepage.textBox.label.versioned':
					'Попробуй Strapi Cloud бесплатно!',
